...
import com.test.memopad.color.ColorPickerDialog;
import com.test.memopad.color.ColorPickerPreference;
import com.test.memopad.view.PaintIt.OnPathListener;
import com.test.memopad.view.PaintIt.PaintView;
import com.test.memopad.view.PaintIt.PathNode;
import com.test.memopad.view.PaintIt.UserInfo;

import java.io.File;

public class PaintViewActivity extends BaseActivity implements View.OnClickListener,View.OnLongClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.color:
                ...
                // then
//                startActivity(new Intent(PaintViewActivity.this, ColorChoiceActivity.class));
                ColorPickerDialog mDialog = new ColorPickerDialog(PaintViewActivity.this, mValue);
                mDialog.show();
                mDialog.getColor();
